...
func printHelp() {
	...
	fmt.Println("  OpenAI-compatible local/LAN endpoint:")
	fmt.Println("    OPENAI_BASE_URL=http://host:port/v1")
	fmt.Println("    OPENAI_API_KEY optional when OPENAI_BASE_URL is custom")
